...
(5, '2024_07_02_153542_create_mytable_table', 1),
(6, '2024_07_16_143740_create_tamus_table', 1);
...
CREATE TABLE `tamus` (
  ...
  `lama_bertamu` datetime NOT NULL,
  `img_face` text NOT NULL,
...
(6, 'kim', '124', 'kim@g.co', NULL, '$2y$12$5hB4JIViBtXamN2asysLXe75dEd1B8HvZ3hNzJYa4q6Peg4zDXleC', NULL, '2024-07-17 23:11:49', '2024-07-17 23:11:49');
...
ALTER TABLE `tamus`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `tamus_nik_unique` (`nik`);
