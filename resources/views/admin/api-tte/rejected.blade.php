...
@section('title', 'Alasan Penolakan Pengajuan API TTE')

@section('content')
<div class="bg-gray-100 shadow-lg rounded-xl p-8">
    <h2 class="text-3xl font-bold mb-6">Masukkan Alasan Penolakan untuk Pengajuan API TTE</h2>

    <form action="{{ route('admin.api-tte.submitRejectionReason', $apiTTERequest->id) }}" method="POST">
        @csrf
        <div class="mb-6">
