...
<div class="flex justify-center items-center min-h-screen bg-gray-100 py-6 sm:py-12">
    <div class="relative w-full max-w-lg mx-auto">
        ...
        <div class="relative px-6 py-12 bg-white shadow-lg rounded-xl sm:rounded-lg sm:p-10">
            <h2 class="text-3xl font-bold leading-tight text-center mb-6 text-gray-900">Formulir Pengajuan Email Kedinasan</h2>
            @if (session('success'))
                <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4" role="alert">
                    <span class="block sm:inline">{{ session('success') }}</span>
                </div>
            @endif
            <form action="{{ route('email.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                @csrf
