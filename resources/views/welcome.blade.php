    ...
    <div class="container mx-auto flex md:flex-row flex-col-reverse items-center">
        <div class="lg:flex-grow mt-5 md:mt-0 md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <div class="flex justify-center">
                <a href="#section-sandi" class="inline-flex text-white bg-emerald-600 border-0 py-2 px-6 focus:outline-none hover:bg-emerald-700 rounded-lg text-lg shadow-md transition transform hover:scale-105">Read More</a>
                <a href="#section-layanan" class="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded-lg text-lg shadow-md transition transform hover:scale-105">Layanan</a>
            </div>
        </div>
        <div class="lg:max-w-lg lg:w-full md:w-1/2 w-full mb-6 md:mb-0">
            <img class="object-cover object-center rounded-lg shadow-lg w-full h-full" alt="hero" src="img/CSIRT (7) FIX.png">
        </div>
    </div>
</section>
    ...
    <div class="container mx-auto px-5">
        ...
        <div class="flex flex-wrap -m-4">
            <div class="p-4 md:w-1/2">
                <div class="flex rounded-lg h-full bg-gray-100 dark:bg-gray-800 p-8 flex-col shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <div class="flex-grow">
                        ...
                        <a href="/layanan/e-sign" class="mt-3 text-indigo-500 inline-flex items-center hover:underline">Learn More
            ...
            <div class="p-4 md:w-1/2">
                <div class="flex rounded-lg h-full bg-gray-100 dark:bg-gray-800 p-8 flex-col shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <div class="flex-grow">
                        ...
                        <a href="/layanan/vulnerability-assessment" class="mt-3 text-indigo-500 inline-flex items-center hover:underline">Learn More
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                                <path d="M5 12h14M12 5l7 7-7 7"></path>
                            </svg>
                        </a>
            ...
            <div class="p-4 md:w-1/2">
                <div class="flex rounded-lg h-full bg-gray-100 dark:bg-gray-800 p-8 flex-col shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <div class="flex-grow">
                        ...
                        <a href="/layanan/e-mail" class="mt-3 text-indigo-500 inline-flex items-center hover:underline">Learn More
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                                <path d="M5 12h14M12 5l7 7-7 7"></path>
                            </svg>
                        </a>
            ...
            <div class="p-4 md:w-1/2">
                <div class="flex rounded-lg h-full bg-gray-100 dark:bg-gray-800 p-8 flex-col shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <div class="flex-grow">
                        ...
                        <a href="/layanan/api-tte" class="mt-3 text-indigo-500 inline-flex items-center hover:underline">Learn More
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                                <path d="M5 12h14M12 5l7 7-7 7"></path>
                            </svg>
                        </a>
