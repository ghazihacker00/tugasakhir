<!-- Header -->
<header class="bg-blue-600 shadow-md fixed top-0 left-0 w-full z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
            ...
            <div class="-mr-2 flex md:hidden">
                <button @click="open = !open" x-data="{ open: false }" @click.away="open = false" class="bg-blue-600 p-2 rounded-md text-white hover:text-gray-300 hover:bg-blue-700 focus:outline-none">
    ...
    <!-- Mobile Navigation -->
    <div x-show="open" x-transition class="md:hidden bg-blue-800 hidden">
