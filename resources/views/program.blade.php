...
<body class="bg-gray-100">
    ...
    <div class="py-12 flex justify-center">
        <div class="bg-white dark:bg-slate-800 shadow-md rounded-lg p-8 max-w-4xl w-full">
            ...
            <div class="space-y-6">
                <div>
                    <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-300 mb-4">1. Penyelenggaraan Persandian untuk Pengamanan Informasi Pemerintah Daerah Kabupaten/Kota:</h2>
                    <ul class="list-disc list-inside text-gray-700 dark:text-gray-400 space-y-2 ml-6">
                ...
                <div>
                    <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-300 mb-4">2. Penetapan Pola Hubungan Komunikasi Sandi Antar Perangkat Daerah Kabupaten/Kota:</h2>
                    <ul class="list-disc list-inside text-gray-700 dark:text-gray-400 space-y-2 ml-6">
